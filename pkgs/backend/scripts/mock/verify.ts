...
async function main() {
  ...
  // verify from ScoreValut
  // get Verifier address
  const SCORE_VALUT_ADDRESS = "0x207026A0c9E2715A6deC09b79bdEb0822bF735C6"; // Scroll Sepolia
  // Get NFT Contract
  const scoreVault = await ethers.getContractAt('ScoreVault', SCORE_VALUT_ADDRESS);

  // verify method
  const tx2 = await scoreVault.verifyProof(
    [
      "0x21dd170b9f3f6e07ac843245ad126df0e5d483a11189634af9c3f6332c20c718", 
      "0x0c694227b621c1b231548795dd119dc4ad63e6a361c1075d81e7630da13fc96d"
    ],[
