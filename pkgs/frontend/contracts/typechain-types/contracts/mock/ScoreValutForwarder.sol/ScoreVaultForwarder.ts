...
export interface ScoreVaultForwarderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eip712Domain"
      | "execute"
...
export interface ScoreVaultForwarder extends BaseContract {
  connect(runner?: ContractRunner | null): ScoreVaultForwarder;
  waitForDeployment(): Promise<this>;

  interface: ScoreVaultForwarderInterface;
